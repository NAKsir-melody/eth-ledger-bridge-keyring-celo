...
const BRIDGE_URL = 'https://naksir-melody.github.io/eth-ledger-bridge-keyring-celo'
const pathBase = 'm'
...
*/
              ...
              if (valid) {
                ...
                reject(new Error('Ledger: The transaction signature is not valid'+ tx.getChainId() +" "+ tx.v + " "+addToV+" "+tempChainId))
 /            }
            } else {
